...
protected:
	 ...
	 * The object with the largest positive priority will be drawn last so it appears on top of the screen.
	 * The object with the largest negative value will be drawn first.
	 */
	int layer;
